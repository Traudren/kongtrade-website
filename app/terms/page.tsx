        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass-effect rounded-2xl p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-white mb-4">3. Риски и responseственность</h2>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  ...
                  <li>User несет полную responseственность за торговые решения</li>
                  ...
                  <li className="font-semibold text-yellow-400 border-l-4 border-yellow-400 pl-4 ml-2">
                    <strong>ВАЖНО:</strong> Не используйте свой депозит, выделенный для бота. 
                    В случае нарушения правил подписки, бот будет отключен в целях безопасности
                  </li>
                </ul>
              </section>
