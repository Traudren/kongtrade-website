  ...
  const handleBotAction = async (userId: string, action: 'start' | 'stop') => {
    try {
      ...
      if (response.ok) {
        ...
        alert(`Error: ${error.message || 'Failed to control bot'}`)
      }
    } catch (error) {
      console.error('Bot control error:', error)
      alert('Error controlling bot. Please try again.')
    }
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            <Link href="/">
              <Image
                src="https://cdn.abacus.ai/images/3eb3da9e-8ada-439f-9102-e248a327a1a8.png"
                alt="KongTrade"
                width={120}
                height={30}
