                        ...
                        <div className="mb-4">
                          ...
                          <div className="text-sm text-gray-300 space-y-2">
                            <div className="space-y-2">
                              ...
                              <p><strong>• Соблюдение правил:</strong> Строго следуйте инструкциям и настройкам бота</p>
                              <p><strong>• Ответственность за риски:</strong> Вы несете полную ответственность за торговые решения и возможные убытки</p>
