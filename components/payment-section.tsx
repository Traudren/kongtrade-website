                      ...
                      <div className="p-6 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
                        <div className="mb-4">
                          <h4 className="font-semibold text-yellow-400 mb-3 text-lg flex items-center">
                            ...
                            Trading Bot Usage Rules
                          </h4>
                          <div className="text-sm text-gray-300 space-y-2">
                            <div className="space-y-2">
                              <p><strong>• Rule Compliance:</strong> Strictly follow instructions and bot setup</p>
                              <p><strong>• Risk Responsibility:</strong> You bear full responsibility for trading decisions and potential losses</p>
                              <p><strong>• Violation Penalties:</strong> Intentional rule violations are punishable by immediate blocking without refund</p>
                              <p><strong>• Confidentiality:</strong> Transfer of configuration files to third parties is prohibited</p>
                              <p><strong>• Activity Monitoring:</strong> All operations are logged and tracked by the security system</p>
                              <p><strong>• Technical Support:</strong> Requests are considered only when all rules are followed</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-3 mt-6">
                          ...
                          >
                            <span className="font-semibold text-white">I accept the risks</span> and agree to comply with all trading bot usage rules. 
                            I understand that rule violations will result in access blocking without refund.
                          </Label>
                        </div>
                      </div>
                    </div>
